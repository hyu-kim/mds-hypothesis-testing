...
ggsave('figures/fig3A_v2.pdf', width=2.55, height=2, units='in')
...
ggsave('figures/fig3B_v2.pdf', width=2.55, height=2, units='in')
...
ggsave('figures/fig3C.pdf', width=2.1, height=2, units='in')
...
ggsave('figures/fig3D.pdf', width=3, height=2, units='in')