...
lambda = 0.2
df_log <- read.csv(paste('result/HyperparameterStudy/iter_',
...
ggplot(df_log) + 
  ...
  geom_point(aes(x=epoch, y=obj_confr*0.02), inherit.aes = FALSE, size=0.5, shape=16) +
  scale_y_continuous(sec.axis = sec_axis(~./0.02, name="Confirmatory")) +
  # ylim(c(0, 6000))+
