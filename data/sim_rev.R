...
get_sim_data_mat <- function(templates, N = 25){
  stool1 <- SparseDOSSA2(template = templates$"1", n_sample = N, n_feature = 332, verbose = FALSE, new_features = FALSE)
  stool2 <- SparseDOSSA2(template = templates$"2", n_sample = N, n_feature = 332, verbose = FALSE, new_features = FALSE)
...
## visualize PCoA
visualize_sim_data <- function(mat){
...
saveRDS(dist, "sim_rev_3-dist.Rds")
